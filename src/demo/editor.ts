...
{
  "shortText": Type.Union([Type.String({
  "title": "Text value",
  "minLength": 1,
  "maxLength": 24
}), Type.Null({
  ...
  "favoriteColor": Type.Optional(Type.String({
  ...
  "optionalRange": Type.Optional(Type.Union([Type.Number({
  "title": "Range value",
  "minimum": 0,
  "maximum": 10,
  "multipleOf": 1
  ...
  "description": "Tests a bounded numeric scalar that renders as a range input and can cycle to null."
})),
  "enabled": Type.Union([Type.Boolean({
  "title": "Boolean value"
}), Type.Null({
  "title": "Null value"
})], {
  ...
  "nullableNote": Type.Optional(Type.Union([Type.String({
  "title": "String value"
}), Type.Null({
  "title": "Null value"
})], {
  ...
  "enums": Type.Object(
{
  "status": Type.Union([Type.Literal("draft"), Type.Literal("review"), Type.Literal("published")], {
  "type": "string",
  "title": "Status"
}),
...
{
  "identity": Type.Intersect([Type.Unknown({
  "$ref": "#/$defs/person"
}), Type.Unknown({
  "$ref": "#/$defs/auditStamp"
})], {
  ...
  "contactChoice": Type.Union([Type.String({
  "title": "Email string",
  "format": "email"
}), Type.Object(
{
  ...
  "pricingStrategy": Type.Union([Type.Unknown({
  "$ref": "#/$defs/fixedPrice"
}), Type.Unknown({
  ...
  "deliveryConfig": Type.Union([Type.Object(
{
...
), Type.Object(
{
  ...
  "description": "Tests discriminated union inference using a shared required discriminator property."
})
}, {
  "title": "Composition",
  ...
  "approvalRules": Type.Object(
{
  ...
  "approvers": Type.Optional(Type.Array(Type.Unknown({
  "$ref": "#/$defs/person"
}), {
  "title": "Approvers"
}))
...
{
  "provider": Type.Union([Type.Literal("saml"), Type.Literal("oauth"), Type.Literal("passwordless")], {
  "type": "string",
  "title": "Provider"
}),
  "issuerUrl": Type.Optional(Type.String({
  "title": "Issuer URL",
  "format": "uri"
})),
  ...
  "maps": Type.Object(
{
  ...
  "patternMap": Type.Intersect([Type.Object(
{
  ...
  "secrets": Type.Object(
{
  ...
  "description": "Low-level JSON Schema 2020-12 fixture for testing primitives, enums, arrays, objects, refs, composition, conditionals, maps, and secrets. Each top-level property is a feature bucket, not a product section.",
  "$defs": {
    "person": {
      "type": "object",
      "title": "Person",
