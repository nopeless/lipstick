...
export function setValueAtPath(current, path, nextValue) {
    if (path.length === 0) {
...
export function deleteValueAtPath(current, path) {
...
export function moveArrayItem(current, path, fromIndex, toIndex) {
