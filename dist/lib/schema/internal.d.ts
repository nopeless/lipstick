...
export declare function resolveLocalRefs(schema: TSchema, _root: TSchema, _seen: Set<string>, resolveSchema: (schema: TSchema, root: TSchema, value: JsonValue | undefined) => TSchema): TSchema;
